...
For this purpose, the customer should create a subdomain (e.g. chat.company.com) which is pointing to our cloud IP address and this domain should be used in the customer’s website to call Unblu.
